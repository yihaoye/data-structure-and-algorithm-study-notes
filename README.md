...
* 了解、推测考核意图 - 比如提出考虑使用 UUID 生成 userID 但是考官询问是否有其他方法（比如简单的整数从零自增 userID++）时，并不是说考官认为在这里使用 UUID 不正确，而是可能考官只是想在接下来的延伸环节里考核多线程情景下的 userID++ 的线程不安全问题与解决方案而已。  
...
摘录自：https://www.zhihu.com/question/30377015/answer/71033131  
