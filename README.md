...
7. 编码七，题解中的一些灵活小技巧，比如对 char 或 string 等非数学数据类型直接互相进行 +/- 操作，可以减少一些繁琐的代码、表达、判断等等。
#### 题型技巧
更多题型、细节技巧请看：  
...
> 或者说高级的，已经不能成为算法了，而是一个实际的现实问题抽象简化而来，都是要使用多个数据结构和算法，综合运用来解决一道问题，以及使用更多数学知识（如[《具体数学》](https://zh.wikipedia.org/wiki/%E5%85%B7%E9%AB%94%E6%95%B8%E5%AD%B8)、[《数值分析》](https://book.douban.com/subject/26600495/)等等）。  
