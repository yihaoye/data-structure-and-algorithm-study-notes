...
4. 思考四，(草稿时)引入一些数学工具、模型 - 如状态机等等有助于理清思路与解题(例子如 Leetcode Q309)，辅助的数学思想还可以包括且不限于加减乘除(商、余数)、开方、指数、对数、导数(例如 Leetcode Q367 牛顿法)、素数、公约数、公倍数、概率、阶乘、数列、坐标、几何函数(sin、cos、tan)、矩阵、不等式、多项式、进位转换等等。
#### 编码时、做题中、Debug
