...
<small>刷题或面试的[编程语言选择](./Program%20Languages%20Features/)：有传言 Google 的工程师说是尽量使用 C++ 和 Java 实现，另外一亩三分地上的讨论也是建议尽量使用 C++ 或 Java。另外用自己熟悉的熟练的语言即可，比如没必要想着 Python 可能比较简洁就从 Java 切换成 Python，总体而言实际中带来的优势可能不大（除非一些语言特定较为麻烦的场景比如大数相关 Java 就比 Python 麻烦）。</small>  
