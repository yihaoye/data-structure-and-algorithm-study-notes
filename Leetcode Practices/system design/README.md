...
![](./serializability.png)  
**存储过程**的一些实例  
现代的存储过程实现放弃了 PL/SQL，而是使用现有的通用编程语言：VoltDB 使用 Java 或 Groovy，Datomic 使用 Java 或 Clojure，而 Redis 使用 Lua（[Redis 6.0 主线程 + IO 线程模型](https://www.cnblogs.com/wzh2010/p/15886804.html)）。  
