...
* 工作可见性
  * 选择任务时考虑可见性
    * 用户/业务直接感知的工作可见性最高（新功能上线、性能提升明显）。
    * 团队依赖的工作次之（别人卡在你这里，完成后大家都看到）。
  ...
  * 与优先级结合
    * 同样重要的事情，优先做可见性更高的，因为这能带来更直接的认可。
...
* 文档写作
  ...
  * 深入浅出
    * 面向不同读者调整深度：对产品经理说业务价值，对开发说实现细节，对领导说 ROI。
    * 善用图表、流程图、对比表格，降低理解门槛。
  * 能力体现
    * 写好文档能放大你的技术成果：别人能快速理解并认可你做的事。
    * 也是跨团队协作和影响力的关键技能：写得好，方案更容易被采纳。
    * 久而久之，你会被视为能把复杂问题讲清楚的人，这是职业发展的加分项。
