...
* 责任感（权责 - 权力的基础）、亲力亲为、身先士卒
  ...
  * 成本预算
* 主动寻求、引导新的发展、探索、方向 - 参考 [Staff Engineer](https://yucliu.gitbook.io/staff-engineer)
...
* 健康沟通、情绪稳定（比如冷静）（对团队士气有影响），
  ...
  * 冲突管理
    * 只专注可及的事情、工作、任务、项目本身，而非与人争执
    * 通过避免加班、合规断联等方法皆可使得同事之间保持合适距离，合适的距离有时可以很好地减少不必要的误会与怨言
