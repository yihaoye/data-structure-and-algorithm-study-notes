    ...
    public static void main(String args[]) {
      try {
            ...
            if (responseCode != HttpURLConnection.HTTP_OK) {
                ...
                // 简陋的 json parse，不能处理复杂的嵌套关系只能简单解析出字符串和数字并 flat，更完整的解析参考：https://www.cnblogs.com/nullllun/p/8358146.html
