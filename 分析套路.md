...
| | (Advanced Design) <br/>不常用/不通用的或编程语言内置里没有的数据结构或类(Twitter) |  | 考虑各种算法并以下数据结构的组合使用：数组、ArrayList、（单向或双向）LinkedList、自定义对象、指针或引用、哈希表、红黑树、哈希集、队列、堆/优先队列、栈、甚至语言内置工具类如 StringBuilder 等等 | Q146 Q208 Q355 Q432 Q2296 Q362
