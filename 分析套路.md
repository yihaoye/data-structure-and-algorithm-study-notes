...
Calculation in XXX/Data-Structure/Data-Type | Calculate Number on 2 LinkedList<br/>基本计算器系列 |  | 模拟算法+进位符/旗帜变量、栈、前缀和、差分数组、递归 | Q2 Q43 Q224 Q227 Q2288 Q772
...
当发现问题貌似没有明显的对应算法解决时，可以尝试一下优化的暴力解 - 比如 `分治法 + 记忆化搜索/DP` 或 `二分搜索 + 模拟/贪心` 等等，例题如 LC Q32、LC Q2560 等等。  
