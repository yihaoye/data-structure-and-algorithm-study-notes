...
| | (Advanced Design) <br/>不常用/不通用的或编程语言内置里没有的数据结构或类(Twitter) |  | 考虑各种算法并以下数据结构的组合使用：数组、ArrayList、（单向或双向）LinkedList、自定义对象、指针或引用、哈希表、红黑树、哈希集、队列、堆/优先队列、栈、甚至语言内置工具类如 StringBuilder 等等 | Q146 Q208 Q355 Q432 Q2296 Q362 Q1381 Q703
...
设计类题目通常首先需要考虑存储数据使用什么容器（比如 Java 容器）。另外设计类通常可以使用哈希表与链表的组合以满足高性能需求。  
