...
- 算法 | Algorithms
  ...
  - 系统级或领域相关 | System Level or Domain Related
    ...
    - 集合统计 - [Ref](https://www.cnblogs.com/520lq/p/14654500.html)
      - 聚合统计 (指统计多个集合元素的聚合结果，包括：`交集统计`统计多个集合的共有元素；`差集统计`把两个集合相比并统计其中一个集合独有的元素；`并集统计`统计多个集合的所有元素)
      - 排序统计 (涉及到数据的排名和顺序等需求，集合本身需是有序集合)
