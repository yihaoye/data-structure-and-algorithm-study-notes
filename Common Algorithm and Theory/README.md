...
- 算法 | Algorithms
  ...
  - 系统级或领域相关 | System Level or Domain Related
    ...
    - [UUID 算法 | Universally Unique Identifier](./UUID.md)
    ...
    - [调度算法 | Scheduling](https://en.wikipedia.org/wiki/Scheduling_(computing)) (相关数学：[排队论 | Queueing Theory](https://en.wikipedia.org/wiki/Queueing_theory)、[利特尔法则 | Little's Law](https://en.wikipedia.org/wiki/Little%27s_law))
      - 非抢占式调度算法
    ...
    - [四叉树算法, R 树算法 | QuadTree, RTree Algorithm](./QuadTree-RTree-算法.md)
      - [HashLife 算法 | HashLife Algorithm](../Other%20Practices/game-of-life/README.md#HashLife)
