...
- 算法 | Algorithms
  ...
  - [数学 | Maths](../Computer%20Science%20Maths/README.md)
    ...
    - 控制论、信息论、系统论 | Cybernetics、Information Theory、Systems Theory (控制论与科学方法论：[Ref 1](https://writings.sh/post/cybernetics-and-scientific-methodology-notes)、[Ref 2](https://book.douban.com/subject/1322336/))
