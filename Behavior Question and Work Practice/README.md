...
* OPT（别人的时间）与 OPM（别人的金钱）- 资源整合
  * 寻找专业人士合作、专家网络
    * **和有资源的人合作**
    * **和负责有能力的人合作**
    * **注重质量而不是数量，要严格筛选（包括人品、信用），平日的交际也是，不要因为孤独（警惕情绪价值诱惑）、虚荣心（比如想被簇拥）、急于求助或错失恐惧心态（FOMO）盲目扩展人脉、呼朋唤友，否则容易得不偿失、被利用或消耗（错误的人脉是负债，比如不成器的亲戚），对于客户也一样的，这样才能专注于正确的合作伙伴与客户。类似的利尽人散的文学故事、真实日常、企业家反面案例有很多**
  * 合理借贷杠杆与投入、现金流
* 信用（对外对内关系都通用）与本能管理
