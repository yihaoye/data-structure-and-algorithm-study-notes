...
- [树 | Tree](./Data%20Structure%20Implementation/Tree/README.md)
  ...
  - 平衡树 | Balanced Tree
    ...
    - [K-D 树 | K-D Tree](./Data%20Structure%20Implementation/KDTree/README.md) ([Wiki](https://zh.wikipedia.org/zh-hans/K-d%E6%A0%91)，最坏情况下可能会退化成链表，因此其平衡性并不稳定，因此业界实际使用更高级的数据结构 - 分层可导航小世界图 / HNSW)
...
- [图 | Graph](./Data%20Structure%20Implementation/Graph/README.md) ([Ref](https://mp.weixin.qq.com/s/wnRQ_9CckAmlQaAjo7q_0w))
  - 有向图 | Directed Graph
    - 有向无环图 | Directed Acyclic Graph, DAG (常用于系统诸如任务调度系统、编译器、网络拓扑排序等领域，[Wiki](https://en.wikipedia.org/wiki/Directed_acyclic_graph)，[图示](./DAG.png))
